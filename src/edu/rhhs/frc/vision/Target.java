...
public class Target {
    ...
    private void updateCalculations() {
        ...
        double offsetAngle = MathUtils.atan(targetOffsetPixels / focalDistancePixels);
        ...
        m_horizontalAngleToSelectedTargetDeg = MathUtils.atan2(centerOffsetFt, m_cameraDistanceFt) * 180.0 / Math.PI;
